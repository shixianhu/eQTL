...
~/gemma-0.98-linux-static -bfile tmp.analysis -p tmp.expression.txt -gxe ../Covariate/Covariate.txt -km 1 -k ../Kinship/IBS.mibs -lmm 4 -o $line.outcome -miss 0.99
rm tmp*
